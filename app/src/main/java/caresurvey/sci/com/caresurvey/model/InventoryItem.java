...
public class InventoryItem {
    ...
    private String instrument_sp_name;
    private String instrument_sp_designation;
    private String i_electronic_autoclev;
    private String i_non_electronic_autoclev;
    private String i_electric_sterilizer;
    private String i_electric_steamer;
    private String i_non_electric_pot;
    private String i_stove;
    private String i_waste_sp_name;
    private String i_waste_sp_designation;
    private String w_waste_option;
    private String w_waste_dispose_how;
    private String w_pointy_waste;
    private String w_liquid_waste;
    private String w_liquid_waste_store;
    private String w_plastic_waste;
    private String w_waste_normal;
    private String w_incinerator_seen;
    private String w_dumping_pit_seen;
    private String equipment_sp_name;
    private String equipment_sp_designation;
    private String w_incinerator;
    private String w_dumping_pit;
    private String n_adult_wing_scale;
    private String n_height_rod;
    private String n_pressure_mechine;
    private String n_stethoscope;
    private String n_filter_stethoscope;
    private String n_water;
    private String n_hand_soap;
    private String n_spirit;
    private String n_waste;
    private String n_sharp_waste;
    private String n_gloves;
    private String n_iron_folate;
    private String n_urine_protien;
    private String n_urine_tester;
    private String n_urine_testtube;
    private String n_test_tube_rack;
    private String n_dip_stick;
    private String n_hemoglobin;
    private String n_telecoil_book;
    private String n_telecoil_landset;
    private String n_kolori_meter;
    private String n_litmus_paper;
    private String delivery_sp_name;
    private String delivery_sp_designation;
    private String d_delivery_table;
    private String d_pressure_mechine;
    private String d_stethoscope;
    private String d_filter_stethoscope;
    private String d_newborn_recuscitation;
    private String d_recuscitation_mask_0;
    private String d_recuscitation_mask_1;
    private String d_peguin_sucker;
    private String d_cord_cutter;
    private String d_cord_clamp;
    private String d_partograf_paper;
    private String d_water;
    private String d_hand_soap;
    private String d_spirit;
    private String d_waste_recycle;
    private String d_waste_storage;
    private String d_latex_gloves;
    private String d_chlorine_sol;
    private String d_detergent_water;
    private String d_clean_water;
    private String d_misoprostol;
    private String d_oxytocin;
    private String d_mang_sulfate;
    private String d_chlorhexidine;
    private String d_paediatric_drop;
    private String d_gentamycin;
    private String ch_wing_scale;
    private String ch_infant_wing_scale;
    private String ch_height_rod;
    private String ch_measuring_tip;
    private String ch_water;
    private String ch_growth_monitor_boy;
    private String ch_growth_monitor_girl;
    private String ch_hand_soap;
    private String ch_spirit;
    private String ch_wastage_recycle;
    private String ch_sharp_waste;
    private String ch_latex_gloves;
    private String ch_ors;
    private String ch_paediatric_drop;
    private String ch_cotrimoxazole;
    private String ch_paracetamol;
    private String ch_zinc;
    private String ch_mebandazole;
    private String ch_ceftriaxone;
    private String ch_vitamin;
    private String fp_soap;
    private String fp_spirit;
    private String fp_waste_recycle;
    private String fp_sharp_waste;
    private String fp_latex_gloves;
    private String r_healthy_newborn;
    private String r_newborn_death;
    private String r_mother_rate;
    private String r_elampsia;
    private String r_mang_sulfate;
    private String r_pneumonis;
    private String r_paracetamol;
    private String r_psbi;
    private String r_psbi_care;
    private String r_starving_child;
    private String r_starving_protocol;
